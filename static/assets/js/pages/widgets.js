...
var KTWidgets = function () {
    ...
    var _initMixedWidget6 = function () {
        ...
        ApiAjaxReader({
            ...
            'success': (data) => {
                ...
                $('#data-new-members-today').html(data["data-new-members-today"])
                $('#data-new-members-week').html(data["data-new-members-week"])
                $('#data-all-personnels-count').html(data["data-all-personnels-count"])
                $('#data-all-members-count').html(data["data-all-members-count"])
                chart.render();
            }
        })
    }
    ...
    var _initMixedWidget23 = function () {
        const element = document.getElementById("kt_tiles_widget_23_chart");
        const color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') : 'primary';
        ...
        ApiAjaxReader({
            'url': SEARCH_CHART_API_URL,
            'success': (data) => {
                $searchCount.innerHTML = data['count']
                const options = {
                    series: [{
                        name: 'Search',
                        data: data.data
